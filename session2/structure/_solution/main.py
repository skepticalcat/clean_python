from session2.structure._solution.src.api.wikipedia_scraper import get_full_text_wiki_article, get_url_of_wiki_article_of_the_day
from session2.structure._solution.src.statistics.statistics import get_most_common_words
from session2.structure._solution.src.utils.utils import get_markdown_from_raw_html, split_text_to_word_list, remove_control_chars
