from clean_python.session2.structure.wikipedia_scraper import get_full_text_wiki_article, get_url_of_wiki_article_of_the_day
from clean_python.session2.structure.statistics import get_most_common_words
